...
HD_PWD='D:/ac/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proiect1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proiect1.tcl -notrace
