...
HD_PWD='D:/ac/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proiect1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proiect1.tcl
